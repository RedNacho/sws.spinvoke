...
The more general pattern here is that the interface and data supplied by the CreateContextCustomisation method give you what you need to work with the class. It's saying, "I would like this information provided in the context, and you need to supply it through this interface." Of course, it's entirely possible that multiple customisations needs to be combined - in this case, you have a couple of options: 1. Create a wrapper which implements all required interfaces, or 2. Customise the context with an IEnumerable of customisations (the .AlsoCustomiseWith method of the customised context can help here).