...
I have added a number of attributes which allow the native delegate signature generated by the proxy to be manipulated in various ways, and pre- and post-processing to be applied.  I wrote some stuff about this in this box but it got lost, so I'll rewrite it later.  In the meantime, see Sws.Spinvoke.Interception.